 ...
 */
class getMoyentpRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MoyentpRepository' shared autowired service.
     *
     * @return \App\Repository\MoyentpRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MoyentpRepository.php';

        return $container->privates['App\\Repository\\MoyentpRepository'] = new \App\Repository\MoyentpRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
