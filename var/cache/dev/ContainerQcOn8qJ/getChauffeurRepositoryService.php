 ...
 */
class getChauffeurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChauffeurRepository' shared autowired service.
     *
     * @return \App\Repository\ChauffeurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChauffeurRepository.php';

        return $container->privates['App\\Repository\\ChauffeurRepository'] = new \App\Repository\ChauffeurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
