...
class __TwigTemplate_f29867ba4abaa1736bcf3a7ac657a9da extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-sm btn-dark\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\Users\\Slim\\Downloads\\auth\\templates\\user\\_form.html.twig");
    }
}
