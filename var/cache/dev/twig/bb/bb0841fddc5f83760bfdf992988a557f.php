...
class __TwigTemplate_4590d7a2fd7e9f80e0fe217b8149943d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <a class=\"btn btn-primary\" style=\"width:300px; margin:1px; background-color:#8DD3BB; margin: 0 auto; display: block;\" type=\"submit\" href=\"";
        // line 8
...
";
    ...
    {
        return array (  100 => 35,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block tableau %}
    ...
    <a class=\"btn btn-primary\" style=\"width:300px; margin:1px; background-color:#8DD3BB; margin: 0 auto; display: block;\" type=\"submit\" href=\"{{ path('app_reponse_index') }}\">back to list</a>
    ...
    {# <table class=\"table\">
        ...
        {% for reponse in reponses %}
            <tr>
                ...
                <td>
                    <a class=\"btn btn-warning\" href=\"{{ path('app_reponse_show', {'id': reponse.id}) }}\">show</a>
                    <a class=\"btn btn-danger\" href=\"{{ path('app_reponse_edit', {'id': reponse.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "reponse/new.html.twig", "C:\\Users\\Slim\\Downloads\\auth\\templates\\reponse\\new.html.twig");
    }
}
