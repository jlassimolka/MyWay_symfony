...
/* baseBack.html.twig */
class __TwigTemplate_0b4ec6bed57c82fa5b878cb1e409013a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "baseBack.html.twig", 1);
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"\">
    ...
    <span class=\"nav-link-text ms-1\">Dashboard</span><ul
     class=\"navbar-nav\">
    <li class=\"nav-item\">
        <a class=\"nav-link\" href=\"";
        // line 47
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_guide_stats");
        echo "\">Statistiques</a>
    </li>
</ul>
  </a>
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"";
        // line 80
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_location_calendar");
        echo "\">
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"";
    ...
    <span class=\"nav-link-text ms-1\">Guides Touristiques</span>
  </a>
</li>
...
\t\t\t\t\t\t\t\t\t";
    ...
    {
        return array (  435 => 343,  425 => 342,  384 => 345,  382 => 342,  349 => 311,  304 => 191,  299 => 188,  283 => 153,  274 => 147,  265 => 141,  256 => 135,  248 => 130,  239 => 124,  231 => 119,  225 => 116,  219 => 113,  206 => 103,  192 => 92,  177 => 80,  160 => 66,  145 => 54,  135 => 47,  103 => 18,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"\">
    ...
    <span class=\"nav-link-text ms-1\">Dashboard</span><ul
     class=\"navbar-nav\">
    <li class=\"nav-item\">
        <a class=\"nav-link\" href=\"{{ path('app_guide_stats') }}\">Statistiques</a>
    </li>
</ul>
  </a>
</li>
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"{{ path('app_location_index') }}\" >
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"{{ path('app_contrat_index') }}\">
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"{{ path('app_location_calendar') }}\">
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white \" href=\"{{ path('app_guide_index') }}\">
...
<li class=\"nav-item\">
  <a class=\"nav-link text-white\" href=\"{{ path('app_chauffeur_index') }}\">
...
<li class=\"nav-item\" >
  <a class=\"nav-link text-white \"href=\"{{path('app_user_index')}}\" >
    ...
    <span class=\"nav-link-text ms-1\" href=\"{{path('app_user_index')}}\">Utilisateur</span>
  </a>
</li>


<li class=\"nav-item\">
  <a class=\"nav-link text-white \"href=\"{{path('app_reponse_index')}}\">
    
      <div class=\"text-white text-center me-2 d-flex align-items-center justify-content-center\">
        <i class=\"material-icons opacity-10\">receipt_long</i>
      </div>
    
    <span class=\"nav-link-text ms-1\" href=\"{{path('app_reponse_index')}}\">Reponse</span>
  </a>
</li>
...
{% endblock %}
", "baseBack.html.twig", "C:\\Users\\Admin\\Desktop\\auth\\templates\\baseBack.html.twig");
    }
}
