...
class __TwigTemplate_64307fcea6b7acf66b2a270a4f46368f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("registration/register.html.twig", "reset_password/request.html.twig", 1);
...
";
    ...
    {
        return array (  127 => 26,  114 => 16,  109 => 14,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'registration/register.html.twig' %}
...
{% block body %}
    ...
    {{ form_start(requestForm) }}
                    <div class=\"input-group input-group-outline mb-3\">
                        {{ form_row(requestForm.email, {'attr': {'class': 'form-control password-field', 'placeholder': 'confirm password' }}) }}
                    </div>
        <div>
            <small>
                Enter your email address and we will send you a
...
{% endblock %}
", "reset_password/request.html.twig", "C:\\Users\\Slim\\Downloads\\auth\\templates\\reset_password\\request.html.twig");
    }
}
