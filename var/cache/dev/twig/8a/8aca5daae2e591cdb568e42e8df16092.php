...
class __TwigTemplate_9d4e52d9c04c3c90d4b6b9ed710c2e5b extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reponse"]) || array_key_exists("reponse", $context) ? $context["reponse"] : (function () { throw new RuntimeError('Variable "reponse" does not exist.', 16, $this->source); })()), "reponse", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Reclamation</th>
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["reponse"]) || array_key_exists("reponse", $context) ? $context["reponse"] : (function () { throw new RuntimeError('Variable "reponse" does not exist.', 20, $this->source); })()), "message", [], "any", false, false, false, 20), "titre", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  127 => 28,  123 => 27,  119 => 26,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block tableau %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Reclamation</th>
                <td>{{ reponse.message.titre }}</td>
            </tr>
        </tbody>
    </table>

    <div class=\"flex-grow-1\" >
    <a class=\"btn btn-success\" href=\"{{ path('app_reponse_index') }}\">back to list</a>
    <a class=\"btn btn-warning\" href=\"{{ path('app_reponse_edit', {'id': reponse.id}) }}\">edit</a>
    {{ include('reponse/_delete_form.html.twig') }}
    </div>
{% endblock %}
", "reponse/show.html.twig", "C:\\Users\\Slim\\Downloads\\auth\\templates\\reponse\\show.html.twig");
    }
}
