...
class ReponseController extends AbstractController
{
    ...
    public function new(Request $request, ReponseRepository $reponseRepository, ReclamationRepository $reclamationRepository, ManagerRegistry $doctrine, int $id): Response
    {
        $reponse = new Reponse();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $reponse->setMessage($reclamation);
        ...
        return $this->renderForm('reponse/new.html.twig', [
            'reponse' => $reponse,
            'reponses' => $reponseRepository->findAll(['message' => $reclamationRepository->find($id)]),
            'form' => $form,
        ]);
    }
